  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Stack(
        ...
        children: [
          if(peer.renderer != null && peer.video != null) RTCVideoView(peer.renderer!)
          else Icon(Icons.person, size: screenHeight),
          Positioned(
            bottom: 0,
            child: Container(
              width: screenWidth,
              height: 25,
              color: Colors.black,
              child: Text("${peer.id}의 화면", style: TextStyle(color: Colors.white), textAlign: TextAlign.left)
            )
          )
        ],
      ),
