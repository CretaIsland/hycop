...
abstract class AbsStorage {
  ...
  static SupabaseClient? _sbStorageConn;

  static Client? get awStorageConn => _awStorageConn;
  static FirebaseApp? get fbStorageConn => _fbStorageConn;
  static SupabaseClient? get sbStorageConn => _sbStorageConn;

  static void setAppwriteApp(Client client) => _awStorageConn = client;
  static void setFirebaseApp(FirebaseApp firebaseApp) =>
      _fbStorageConn = firebaseApp;
  static void setSupabaseApp(SupabaseClient supabaseClient) =>
      _sbStorageConn = supabaseClient;
  ...
  Future<bool> createThumbnail(
      String fileId, String fileName, String fileType, String bucketId);
